...
import { Accordion, Accordions } from "@/components/ui/native-accordion"

export default function FAQ() {
  return (
    <Accordions className="mx-auto max-w-2xl">
      <Accordion key="1" title="What is AI Chat? Why did you create it?">
      ...
      <Accordion key="2" title="Is it free?">
        Yes, AI Chat is a free ChatGPT desktop app.
      </Accordion>
      <Accordion key="3" title="What chatbots (LLM models) can I use in AI Chat?">
      ...
      <Accordion key="4" title="What are the system requirements for AI Chat?">
      ...
      <Accordion key="5" title="Is AI Chat available in the Mac App Store?">
